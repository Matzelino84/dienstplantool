              ...
              return (
                <button
                  ...
                  className={cn(
                    ...
                    status === "leer" && isHoliday && "bg-white/20 ring-1 ring-white/35",
                    status === "leer" && isFerien && "bg-slate-300/20 ring-1 ring-slate-300/35",
          ...
          <div className="mt-5 pt-4 border-t border-white/5 space-y-3">
            ...
            <div className="flex items-center justify-center gap-3 text-[11px] text-white/30">
              <div className="flex items-center gap-1.5">
                <div className="h-3 w-3 rounded bg-slate-300/20 ring-1 ring-slate-300/35" />
                <span>Schulferien</span>
              </div>
              <div className="flex items-center gap-1.5">
                <div className="h-3 w-3 rounded bg-white/20 ring-1 ring-white/35" />
                <span>Feiertag</span>
              </div>
            </div>
          </div>
